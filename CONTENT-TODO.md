...
- **Stats** — the homepage and About `X+` placeholders are now 40+ years in
  public accounting / 10 years independent / $200K–$20M client revenue range.
- **Trust badges** — "Licensed CPA Firm" became "Florida-Licensed CPA" and
  "40+ Years in Public Accounting", both verifiable.
...
| 10 | **Photography** | `lib/images.js` — see below. |
