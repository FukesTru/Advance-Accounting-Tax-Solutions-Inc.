      ...
      <Container className="py-14 sm:py-16">
        <div className="prose-legal max-w-3xl">
          ...
          <p>
            ...
            portal rather than email, access to client files is limited to the people who need it,
          ...
          <ul>
            <li>
              <strong>{site.portalProvider}</strong> — our client portal, used for secure document
              exchange and messaging. Documents are stored on their infrastructure under their
              security program.
            </li>
            <li>
