 ...
 * Service-area pages.
 *
 * Every entry carries its own intro, local-authority detail, FAQs, and
 * testimonial. That is deliberate: near-identical city pages that differ only
...
export const areas = [
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'No. Cape Coral is about an hour from Ave Maria, and most clients there work with us entirely remotely — secure portal for documents, video calls for planning. If you would rather meet in person, we are glad to; it is simply not required.',
      },
    ],
    testimonial: {
      quote:
        'Payroll and filings just happen now. That is worth a lot when you are running crews and quoting jobs all day.',
      name: 'Placeholder Client',
      detail: 'Trades business owner · Cape Coral, FL',
    },
  },
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Ave Maria is roughly a 40-minute drive from Bonita Springs, and we meet clients at the office by appointment. Most people find one or two in-person sessions a year is plenty, with the rest handled by video call and secure portal.',
      },
    ],
    testimonial: {
      quote:
        'Straight answers, fast replies, and no jargon. I have referred three other people in the neighborhood already.',
      name: 'Placeholder Client',
      detail: 'Retired professional · Bonita Springs, FL',
    },
  },
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    testimonial: {
      quote:
        'The fractional CFO work paid for itself in one pricing conversation. We finally understand our margins by service line.',
      name: 'Placeholder Client',
      detail: 'Professional services firm · Estero, FL',
    },
  },
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    testimonial: {
      quote:
        'We were setting up a second entity for the rental and had no idea how to structure it. The recommendation was clear and the tax reasoning was explained plainly.',
      name: 'Placeholder Client',
      detail: 'Property owner · Marco Island, FL',
    },
  },
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    testimonial: {
      quote:
        'Having someone local who actually understands how a seasonal business runs has made the whole year easier to plan.',
      name: 'Placeholder Client',
      detail: 'Family business owner · Immokalee, FL',
    },
  },
];
