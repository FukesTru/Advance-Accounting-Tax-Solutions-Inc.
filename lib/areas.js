...
export const areas = [
    ...
    faqs: [
      {
        ...
        a: 'Yes. Our office in Ave Maria is an easy drive from Naples, and we meet clients there by appointment. For planning conversations that benefit from being face to face — estate coordination or a business succession discussion, say — we are happy to arrange something closer to you. Everything else runs comfortably over video call.',
      },
      {
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'No. Cape Coral is the far side of Lee County from our Ave Maria office, and most clients there work with us entirely remotely — video calls for planning, electronic filing for returns. If you would rather meet in person, we are glad to; it is simply not required.',
      },
    ],
  },
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Ave Maria is a straightforward drive from Bonita Springs, and we meet clients at the office by appointment. Most people find one or two in-person sessions a year is plenty, with the rest handled by video call and phone.',
      },
    ],
  },
  ...
  /* ---------------------------------------------------------------- */
  {
    ...
    county: 'Collier County',
    cardBlurb:
      'Agricultural, seasonal-payroll, and small business accounting from our Ave Maria office next door.',
    metaTitle: 'Accountant & Tax Advisor in Immokalee, FL',
    metaDescription:
      'Agricultural accounting, seasonal payroll, and small business tax services in Immokalee, FL, from our neighbouring Ave Maria office.',
    ...
    intro: [
      ...
      'Being the next community over helps. We handle bookkeeping and payroll for businesses with seasonal workforces, tax planning that works around a harvest calendar rather than a corporate one, and entity and succession work for family businesses being handed to the next generation.',
    ],
    localAuthority: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Barely any distance at all. We are in Ave Maria, which makes Immokalee our nearest community — in-person meetings are easy to arrange, and we are glad to visit the operation when seeing it makes the conversation more useful.',
      },
    ],
  },
];
