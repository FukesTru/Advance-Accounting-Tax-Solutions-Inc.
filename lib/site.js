 ...
 * accounting-tax-solutions.com. Sourced, not assumed.
 */
 ...
 * Homepage stat row.
 *
 * "Years in public accounting" (42), "Years in independent practice" (10), and
...
export const stats = [
  ...
  { label: 'Years in independent practice', value: '10' },
  { label: 'Client revenue range served', value: '$200K – $20M' },
];

/** Extended stat row for the About page. Last two are ESTIMATES. */
...
export const team = [
  {
    ...
    role: 'President & CEO',
    bio: 'Florida-licensed CPA with 42 years in public accounting, the last ten in independent practice. Handles tax planning, compliance, resolution work, and advisory engagements directly.',
  },
  {
