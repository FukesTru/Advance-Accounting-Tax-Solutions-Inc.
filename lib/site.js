...
export const site = {
  ...
  // TODO(client): if TitanFile issued the firm a branded sign-in subdomain,
  // use it here instead of the generic login page.
  portalProvider: 'TitanFile',
  portalLoginUrl: 'https://www.titanfile.com/login/',
