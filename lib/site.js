...
export const site = {
  ...
  // No business hours are published. The ones that used to sit here were an
  // assumption, not something the client supplied. TODO(client): send the real
  // hours and they go back into the footer, the contact page and
  // openingHoursSpecification in lib/schema.js.
  // Confirmed by the client: the firm exchanges documents through TitanFile,
  // on the US instance. Supplied by the client, so it is not a placeholder.
  portalProvider: 'TitanFile',
  portalLoginUrl: 'https://us.titanfile.com/login/?next=/',
...
/**
 * Stat row on the homepage "Our Story" section.
 *
 * Both figures were confirmed directly by the client. The estimated figures
 * that used to sit alongside them — returns prepared, clients served,
 * industries supported — were never measured and have been removed.
 */
export const stats = [
