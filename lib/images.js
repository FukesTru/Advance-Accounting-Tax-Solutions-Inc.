...
export const images = {
  ...
  heroHome: slot({
    key: 'heroHome',
    // TODO(client): drop a wide office or full-team photo in as hero.jpg and it
    // takes over automatically, with the matching alt text below.
    local: ['/images/hero.jpg', '/images/ave-maria.jpg'],
    localAlts: {
      '/images/hero.jpg':
        'The Advance Accounting & Tax Solutions team at their office in Ave Maria, Florida',
      '/images/ave-maria.jpg':
        'Ave Maria, Florida town center, where Advance Accounting & Tax Solutions is based',
    },
    alt: 'Southwest Florida, where Advance Accounting & Tax Solutions serves its clients',
    icon: 'users',
    aspect: '4/3',
    unsplash:
      'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=1400&q=70&auto=format&fit=crop',
  }),
  joseph: slot({
    key: 'joseph',
