...
function slot({ key, alt, icon = 'users', unsplash }) {
  return {
    key,
    alt,
    icon,
    unsplash,
    src: useStock ? unsplash : null,
  };
}
...
export const images = {
  heroHome: slot({
    key: 'heroHome',
    alt: 'Joseph Fragnoli reviewing a tax plan with a client at the Advance Accounting & Tax Solutions office',
    icon: 'users',
  ...
  joseph: slot({
    key: 'joseph',
    alt: 'Joseph Fragnoli, founder of Advance Accounting & Tax Solutions, Inc.',
    icon: 'users',
